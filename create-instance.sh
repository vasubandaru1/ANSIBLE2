...
aws ec2 run-instances --launch-template LaunchTemplateId=lt-0e55b52761f52579b,Version=01 --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=$1}]" "ResourceType=spot-instances-request,Tags=[{Key=Name,Value=$1}]" | jq &>/dev/null
